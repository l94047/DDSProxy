...
.. code-block::
    ...
    docker run --net=host -it -v <path/to/file>/ddsproxy_net_A.yaml:/ddsproxy_net_A.yaml ubuntu-fastdds-suite:<FastDDS-Version>
    ddsproxy -c /ddsproxy_net_A.yaml
...
.. code-block:: bash
    ...
    docker run --net=host -it -v <path/to/file>/ddsproxy_net_B.yaml:/ddsproxy_net_B.yaml ubuntu-fastdds-suite:<FastDDS-Version>
    ddsproxy -c /ddsproxy_net_B.yaml
