...
Execute the |ddsproxy| with this configuration file (available in
``<path/to/ddsproxy_tool>/share/resources/configurations/examples/change_domain_allowlist.yaml``).
...
``<path/to/ddsproxy_tool>/share/resources/configurations/examples/change_domain.yaml``).
