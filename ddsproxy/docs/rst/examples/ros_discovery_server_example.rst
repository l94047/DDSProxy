...
For a detailed explanation on how to execute the |ddsproxy|, refer to this :ref:`section <user_manual_user_interface>`.
...
Execute |ddsproxy| with this configuration file (available in
``<path/to/ddsproxy_tool>/share/resources/configurations/examples/ros_discovery_server.yaml``).
Once the |ddsproxy| is running, messages from *talker* in domain 0 will be forwarded by the Router
