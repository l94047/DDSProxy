...
a |ddsproxy| with an active Discovery Server WAN Participant.
...
Each of the networks to be connected require a running |ddsproxy|, and the messages will be relay from one to
...
the |ddsproxy| for WAN communication.
