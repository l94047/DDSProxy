...
This :term:`Participant` prints in ``stdout`` all the discovery information and/or user data that is received by the |ddsproxy|.
...
of the Participants of the |ddsproxy|.
