...
void YamlReader::fill(
        ddsproxy::core::SpecsConfiguration& object,
        const Yaml& yml,
...
template <>
ddsproxy::core::types::ParticipantKind YamlReader::get(
        const Yaml& yml,
        const YamlReaderVersion /* version */)
{
    // Domain id required
    return get_enumeration_from_builder<ddsproxy::core::types::ParticipantKind>(yml,
                   *ddsproxy::core::types::ParticipantKindBuilder::get_instance());
}
...
{
    // Kind required
    ddsproxy::core::types::ParticipantKind kind = YamlReader::get<ddsproxy::core::types::ParticipantKind>(yml,
                    PARTICIPANT_KIND_TAG,
                    version);

    logInfo(DDSPROXY_YAML_CONFIGURATION, "Loading Participant of kind " << kind << ".");

    switch (kind)
    {
        case ddsproxy::core::types::ParticipantKind::echo:
        ...
        case ddsproxy::core::types::ParticipantKind::simple:
        ...
        case ddsproxy::core::types::ParticipantKind::discovery_server:
        ...
        case ddsproxy::core::types::ParticipantKind::initial_peers:
        ...
        case ddsproxy::core::types::ParticipantKind::xml:
...
template <>
void YamlReader::fill(
        ddsproxy::core::DdsProxyConfiguration& object,
        const Yaml& yml,
        const YamlReaderVersion version)
{
    /////
    ...
    {
        ddsproxy::core::types::ParticipantKind kind =
                YamlReader::get<ddsproxy::core::types::ParticipantKind>(conf, PARTICIPANT_KIND_TAG, version);
    ...
    {
        YamlReader::fill<ddsproxy::core::SpecsConfiguration>(
    ...
    */
    object.ddspipe_configuration.master_flag = object.advanced_options.master_flag;
...
template <>
ddsproxy::core::DdsProxyConfiguration YamlReader::get<ddsproxy::core::DdsProxyConfiguration>(
        const Yaml& yml,
        const YamlReaderVersion version)
{
    ddsproxy::core::DdsProxyConfiguration object;
    fill<ddsproxy::core::DdsProxyConfiguration>(object, yml, version);
    return object;
}
