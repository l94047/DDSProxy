 ...
 */
TEST(YamlGetConfigurationDdsProxyTest, get_ddsproxy_configuration_trivial)
{
    const char* yml_str =
            R"(
            version: v4.0
    ...
    // Load configuration
    ddsproxy::core::DdsProxyConfiguration configuration_result =
            ddsproxy::yaml::YamlReaderConfiguration::load_ddsproxy_configuration(yml);
    ...
    std::set<std::pair<ddsproxy::core::types::ParticipantKind,
    ...
    {
        ASSERT_EQ(participant.first, ddsproxy::core::types::ParticipantKind::echo);
    }
}
 ...
 */
TEST(YamlGetConfigurationDdsProxyTest, get_ddsproxy_configuration_ros_case)
{
    const char* yml_str =
            R"(
            version: v4.0
    ...
    for (auto participant : participant_configurations)
    {
        ASSERT_EQ(participant.first, ddsproxy::core::types::ParticipantKind::simple);
    }
}
