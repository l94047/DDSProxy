 ...
 */
// TEST(YamlReaderConfigurationTest, ddsproxy_configuration_v1_not_supported)
// {
 ...
 */
// TEST(YamlReaderConfigurationTest, get_ddsproxy_configuration_v2)
// {
//     std::vector<const char*> yml_configurations =
//     {
//         // trivial configuration
 ...
 */
TEST(YamlReaderConfigurationTest, get_ddsproxy_configuration_no_version)
{
    // trivial configuration of v4.0
    {
