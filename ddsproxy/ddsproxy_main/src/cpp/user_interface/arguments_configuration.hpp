...
#ifndef EPROSIMA_DDSPROXY_USERINTERFACE_ARGUMENTSCONFIGURATION_HPP
#define EPROSIMA_DDSPROXY_USERINTERFACE_ARGUMENTSCONFIGURATION_HPP
...
#endif /* EPROSIMA_DDSPROXY_USERINTERFACE_ARGUMENTSCONFIGURATION_HPP */
