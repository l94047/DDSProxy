...
from ddsproxy_yaml_validator.validator import YamlValidator


# Move to project root level
os.chdir(os.path.dirname(os.path.abspath(__file__)) + '/../../..')

SCHEMA_PATH = 'tools/ddsproxy_yaml_validator/ddsproxy_yaml_validator/' \
              'ddsproxy_config_schema.json'
...
INVALID_CONFIGURATION_FILES = [
    'tools/ddsproxy_yaml_validator/tests/invalid_configuration_files']
