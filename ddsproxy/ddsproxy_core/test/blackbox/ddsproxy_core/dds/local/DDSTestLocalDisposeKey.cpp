 ...
 */
DdsProxyConfiguration dds_test_simple_configuration()
{
...
void test_local_communication_key_dispose(
        DdsProxyConfiguration ddsproxy_configuration,
        ...
        uint32_t msg_size = DEFAULT_MESSAGE_SIZE)
{
    ...
    // eprosima::ddsproxy::test::TestLogHandler test_log_handler(utils::Log::Kind::Error);
    ...
    DdsProxy router(ddsproxy_configuration);
