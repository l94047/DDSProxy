...
#include <ddsproxy_core/configuration/SpecsConfiguration.hpp>
...
/**
 * This data struct joins every DdsProxy feature configuration such as:
 * - DdsPipe configuration.
 * - Participant configurations.
 * - Advanced configurations.
 */
struct DdsProxyConfiguration : public ddspipe::core::IConfiguration
{
    ...
    //! Default constructor
    DDSPROXY_CORE_DllAPI DdsProxyConfiguration() = default;
    ...
    DDSPROXY_CORE_DllAPI bool is_valid(
