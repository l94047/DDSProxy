...
/**
 * @file DdsProxyConfiguration.cpp
 *
 */
...
bool DdsProxyConfiguration::is_valid(
        utils::Formatter& error_msg) const noexcept
{
            ...
            configuration : participants_configurations)
    {
        ...
        {
            logDevError(DDSPROXY_CONFIGURATION, "Invalid ptr in participant configurations.");
...
bool DdsProxyConfiguration::check_correct_configuration_object_(
